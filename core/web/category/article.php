...
//abs()函数，取绝对值
	...
	$condition.=" AND setfor LIKE 'article' ";
...
elseif ($operation == 'copy') {
	...
	if (checksubmit('submit')) {
		...
		$data = array(
			...
			fmMod_log_record($_W['uniacid'],$_W['uniacid'],$_W['uid'],$fanid,$openid,'fm453_shopping_category',$id,'add',$dologs);
			unset($dologs);
			message('添加分类成功！', fm_wurl($do,$ac,'modify', array('id'=>$id,'psn'=>$psn)), 'success');
		}
	//包含的模板文件
