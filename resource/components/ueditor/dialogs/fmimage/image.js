    ...
    RemoteImage.prototype = {
        ...
        initEvents: function () {
            ...
            domUtils.on($G("lock"), 'change', function(){
				...
				// BY FM453 测试宽度百分比的值
            domUtils.on($G("width_percent"), 'keyup', function(){
                $G('width').value = '';
                $G('height').value = '';
            });
        ...
        setImage: function(img){
            ...
            if(src) {
                ...
                $G("width_percent").value = img.getAttribute("percent") || '100';	//从width-percent中取百分值,最大100
        ...
        setPreview: function(){
            ...
            if(url) {
            	if(ow_p){
            		preview.innerHTML = '<img src="' + url + '" width="' + ' "auto" ' + '" percent="' + ow_p + '" height="' + ' "auto" ' + '" border="' + border + 'px solid #000" title="' + title + '" />';
            	}else{
        ...
        getInsertList: function () {
            ...
            if(data['url']) {
            	if(data['width_percent']){
                    ...
                    _src: data['url'],
                    width: '',
                    percent: data['width_percent'] || '100',
                    height: '',
                    border: data['border'] || '',
                    ...
                    title: data['title'] || '',
                    alt: data['title'] || '',
                    style: "width:" + data['width'] + "px;height:" + data['height'] + "px;max-width:100%;"
                }];
            	}
            } else {
                return [];
