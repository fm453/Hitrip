...
$settings['needs']['whyIdcard'] = isset($settings['needs']['whyIdcard']) ? $settings['needs']['whyIdcard'] : '您的身份证件信息为我们用于为您及您的团队购买保险、作颁发奖品凭证等；我们着重承诺，为您的隐私信息保密，不向任何其他无关第三方透露。';
//活动类型
...
//桌号对应区域分布
$desk_areas=array();
$desk_areas['cats']=array(
	'cat1'=>'安庆',
	'cat2'=>'合肥',
);

//默认的价格
$needs['price'] = !isset($needs['price']) ? $needs['price'] : 100;
